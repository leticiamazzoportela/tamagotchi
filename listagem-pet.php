...
=======
>>>>>>> fba36fff5c1a435414dca38b2112a661c313355c
        <!-- CSS -->
                                    ...
                                    <script>
                                        $(function () {
                                            $('[data-toggle="popover"]').popover({
                                                html: true,
                                                content: '<a class="btn btn-outline-dark rounded-circle" href="criarPet.php" role="button"><img src="https://png.icons8.com/color/48/000000/rabbit.png"></img></a>,<a class="btn btn-outline-dark rounded-circle" href="criarPet.php" role="button"><img src="https://png.icons8.com/color/48/000000/cute-hamster.png"></img></a>, <a class="btn btn-outline-dark rounded-circle" href="criarPet.php" role="button"><img src="https://png.icons8.com/color/30/000000/puffin-bird.png"></img></a>, <a class="btn btn-outline-dark rounded-circle" href="criarPet.php" role="button"><img src="https://png.icons8.com/color/30/000000/strawberry.png"></img></a>, <a class="btn btn-outline-dark rounded-circle" href="criarPet.php" role="button"><img src="https://png.icons8.com/color/30/000000/insect.png"></img></a>'})
                                        })
                                    </script>
